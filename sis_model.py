...
class SISNetwork:
    def __init__(self, graph, initial_seeds: List[int], infection_probability: float,
        ...
        ----------
        graph
            The underlying directed graph representing the network.
        initial_seeds : List[int]
            List of nodes that are initially infected.
        infection_probability : float
            Probability of infection spreading from an infected node to a susceptible neighbor.
        healing_probability : float
            Probability of an infected node becoming susceptible (healing) in each time step.
        """
        self.graph = graph
    ...
    def get_node_heal_prob(self, node: int) -> float:
        ...
        ----------
        node : int
            The node to get the healing probability for.
    ...
    def get_node_infect_prob(self, node: int) -> float:
        ...
        ----------
        node : int
            The node to get the infection probability for.
    ...
    def get_infection_status(self) -> np.ndarray:
        ...
        -------
        np.ndarray
            A binary array where 1 indicates that the node is infected and 0 indicates that the node is susceptible.
        """
    ...
    def vaccinate_node(self, node: int, healing_scalar=1, infection_scalar=1):
        ...
        ----------
        node : int
            The node to vaccinate.
        healing_scalar : float
            The scalar to multiply the healing probability by.
        infection_scalar : float
            The scalar to multiply the infection probability by.
        """
    ...
    def vaccinate_nodes(self, nodes: List[int], healing_scalar=1, infection_scalar=1):
        ...
        ----------
        nodes : List[int]
            The list of nodes to vaccinate.
        healing_scalar : float
            The scalar to multiply the healing probability by.
        infection_scalar : float
            The scalar to multiply the infection probability by.
